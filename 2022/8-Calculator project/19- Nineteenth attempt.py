...
def calc_number_a_b_c(number):
    global number_one , sign_operator , number_two , cash_result , finall_result
    if sign_operator == '':
...
def equal_operator(): # =
    ...
    if number_one != '' and sign_operator != '' and number_two != '':
        if sign_operator == '+':
            finall_result = float(number_one) + float(number_two)
            lbl_result['text'] = finall_result
...
def clear_command(): # Clear every thing
    global number_one , sign_operator , number_two , cash_result , finall_result
    number_one , sign_operator , number_two = ('','','')
    cash_result , finall_result = (float,float)
    print(f'number one: {number_one}')
    print(f'sign operator: {sign_operator}')
    print(f'number two: {number_two}')
    print(f'cash result: {cash_result}')
    print(f'finall result: {finall_result}')
    lbl_result['text'] = ''
    lbl_numbers_and_operator['text'] = ''
